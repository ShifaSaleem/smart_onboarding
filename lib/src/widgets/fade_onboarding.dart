...
class FadeOnboarding extends StatefulWidget {
  ...
  @override
  State<FadeOnboarding> createState() => _FadeOnboardingState();
}

class _FadeOnboardingState extends State<FadeOnboarding> {
